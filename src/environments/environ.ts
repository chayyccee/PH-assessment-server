...
import { EnvironmentFile, Environments } from './environ.constants';
import IEnvironment from './environ.interface';
...
class Environment implements IEnvironment {
    ...
    constructor(NODE_ENV?: string) {
      ...
      const port: string | undefined | number = process.env.PORT || 4003;
